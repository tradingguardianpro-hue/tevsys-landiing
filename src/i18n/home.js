...
export const homeCopy = {
	es: {
		...
		inviteLinkOp: 'Operación abierta que cruza días — sigues protegido →',
		...
		auditLead:
			'No auditamos tu estrategia: verificamos ejecución, precisión de cierre, cumplimiento de límites y la evidencia que deja tevsys frente a MT5 — el mismo rigor con el que medimos cada capa del producto.',
		auditBridge:
			'Hoy ya puedes contrastar MT5 y los registros de tevsys por tu cuenta. Estamos preparando una revisión asistida con dictamen estructurado — para cuando el producto y el flujo estén listos al nivel que exigimos.',
		auditPointsAria: 'Qué revisamos en la auditoría',
		auditLi1: 'Acta de lo pactado y de lo ocurrido: límites, protecciones, cierres y momentos clave.',
		auditLi2: 'El mismo periodo contrastado: registros tevsys + informe oficial MT5.',
		auditNote: 'Pensado para traders, academias y equipos que exigen trazabilidad real — no relato.',
	...
	en: {
		...
		seoDescription: `MetaTrader 5 utility that enforces the rules the trader configures: loss and profit limits (day and week), OFF days and the lock that blocks new trades once a limit is reached — intraday and on swing. Documented precision, HyperClose and a record you can check against MT5. It does not trade for you. ${settings.documentedOperatives} documented trades.`,
		hero: {
		...
		inviteLinkOp: 'Open trade across days — you stay protected →',
		...
		auditLead:
			'We do not audit your strategy: we verify execution, close precision, limit compliance and the evidence tevsys leaves against MT5 — the same rigor we use to measure every layer of the product.',
		auditBridge:
			'Today you can already cross-check MT5 and tevsys records yourself. We are preparing an assisted review with a structured finding — when the product and the flow are ready at the standard we require.',
		auditPointsAria: 'What we review in the audit',
		auditLi1: 'A record of what was agreed and what happened: limits, protections, closes and key moments.',
		auditLi2: 'The same period, side by side: tevsys records + official MT5 report.',
		auditNote: 'Built for traders, academies and teams that demand real traceability — not a story.',
