...
| E2 | `.tevsys-home-mid-glow::before` (segunda burbuja / aureola) | `tevsys-home-mid-bubbles-b` | **118s** | **`linear`** `infinite` (**sin** `alternate`; delay **-26.8s** desktop / **-29.5s** móvil) | Misma filosofía; ruta distinta. |
