...
| G | `.tevsys-home-tail-bubble-solo` | `tevsys-home-tail-bubble-solo` (**38s**); en **≥769px** `tevsys-home-tail-bubble-solo-desktop` | **38s** | `ease-in-out` `alternate` | Una burbuja radial; cruza viewport con ligero zigzag; máscara gradiente inferior para no competir con footer. Escritorio: misma trayectoria, opacidad/radial un poco más presentes. |
