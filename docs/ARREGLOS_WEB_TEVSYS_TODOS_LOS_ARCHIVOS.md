...
- **Solución:** keyframes dedicados **`*-mobile`**: posición de fondo con **X** ~centro y **Y** variando a lo largo del stack; segunda capa (`::before`) con ruta y fase distintas; duraciones **28s** / **33.7s** sin cambio.
...
**Estado extendido 25–26 Mar 2026:** `CHANGELOG-TEVSYS.md` **§58** (hero unificado, galería MT5 HyperClose, 65 operativas, HTML redactado).
