...
- **P13 + pack espejo (8–9 sep):** `#rama-operacion` (copy edge intacta) · **`#overnight-laborable`** guía ~1:15 · `#overnight-faq` · `#faq-espejo` · `#vigilancia-vps` · Para quién sin MAM. V12 **(p13GuiaWeb)**. Pendiente caso ★ · re-auditoría buscador.
