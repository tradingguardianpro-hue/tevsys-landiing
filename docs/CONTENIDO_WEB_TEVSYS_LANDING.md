...
- **Mid-home microclips (23 ago 2026 · chip finde 29 ago):** tras las 4 cards — *¿Quieres ver cómo reacciona…?* · lead: Nasdaq (~3:35) · clips ~30 s · guías · **chip** *Operación abierta en finde — sigues protegido* → `/go/como-funciona-operacion` → `#rama-operacion` · CTA `Ver cómo funciona →` → `/go/como-funciona-home`.
