...
- **Guía Desde cero (20 ago 2026):** `/como-funciona#desde-cero` · eyebrow **Condición innegociable** · título *Desde cero, siempre* · ~57 s · `tevsys-guia-desde-cero.mp4` · observación pasiva + empezar de cero · micro rama `#videoclip-pasiva` se mantiene. **Fix:** CSS sin recorte · poster sin cartela · sin puente “versión corta”. `?v=20260820b`.
