...
- **Tu ID tevsys (9 sep 2026):** `/como-funciona#tu-id-tevsys` ES|EN — lead del acto Auditoría (tras corte *fase de auditoría*). Identidad del caso / código `TVS-…`. Captura modal **pendiente** (`captureSrc` vacío → placeholder).
