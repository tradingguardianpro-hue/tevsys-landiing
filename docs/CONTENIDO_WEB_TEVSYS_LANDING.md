...
- **Actos post-Capital (30 ago 2026):** *Siguiente nivel* (cáscara negra) → *Las cuatro piezas* (*Cada capa, con detalle*) → *Mimetiza el panel a tu gusto* (borde/discreto + 3 destellos; clip claro pendiente) → auditoría cian.
