...
- **Mid-home microclips (23 ago 2026):** tras las 4 cards — *¿Quieres ver cómo reacciona…?* · lead: Nasdaq (~3:35) · clips ~30 s · guías Desde cero y puesta en marcha · CTA `Ver evidencia en vídeo →` → `/como-funciona` (puerta al hub; sin lista de enlaces).
