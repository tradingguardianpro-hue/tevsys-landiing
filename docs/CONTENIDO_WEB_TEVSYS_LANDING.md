...
- **Mid-home microclips (23 ago 2026):** tras las 4 cards — *¿Quieres ver cómo reacciona…?* · lista al mismo peso: **Desde cero** · **Configurar límites (~1 min)** · **Clips cortos (~30 s)** · CTA `Ver en Cómo funciona →` → `/como-funciona`.
