...
- `precision`
  ...
  - Hook: `65 operativas documentadas. 0,06% de error medio en condiciones normales.` *(26 Mar 2026; §58)*
- `hyperclose`
...
| Resumen estadístico (0,06%) | KPIs + enlace auditoría | 65 operativas documentadas | ✅ |
