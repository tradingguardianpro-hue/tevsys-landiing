...
- `precision`
  ...
  - Hook: `114 operativas documentadas. 0,06% de error medio en condiciones normales.` (fuente `settings.js` · MD precisión §3) *(22 ago 2026)*
- `hyperclose`
...
| Resumen estadístico (0,06%) | KPIs + enlace auditoría | 114 operativas documentadas | ✅ |
