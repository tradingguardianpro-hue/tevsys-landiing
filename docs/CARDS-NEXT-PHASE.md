...
- `precision`
  ...
  - Hook: `97 operativas documentadas. 0,06% de error medio en condiciones normales.` (fuente `settings.js` · MD precisión §3) *(26 Mar 2026; §58)*
- `hyperclose`
...
| Resumen estadístico (0,06%) | KPIs + enlace auditoría | 97 operativas documentadas | ✅ |
