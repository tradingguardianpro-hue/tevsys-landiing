...
- `precision`
  ...
  - Hook: `112 operativas documentadas. 0,06% de error medio en condiciones normales.` (fuente `settings.js` · MD precisión §3) *(22 ago 2026)*
- `hyperclose`
...
| Resumen estadístico (0,06%) | KPIs + enlace auditoría | 112 operativas documentadas | ✅ |
