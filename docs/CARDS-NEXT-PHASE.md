...
- **19 abr 2026 (cerrado en código + docs):** stack hero **`#000`**; **DM Sans** solo en H1 home; imágenes cards renovadas (**card 1** `card-1-input.png` engranaje motor + **`?v=8`**); **Inter** en tema oscuro global (`theme.css`); CTAs demo unificados (`global.css`); contacto con **Inter** explícita; escáner header con **intensidad restaurada** (duraciones 29,5s / 28s / 23,5s); **`.feature-hero`** con respiro global; **Precisión:** orden demos volatilidad → Nasdaq → cuenta pequeña → logs.
...
3. Si algo se publica en web, registrar también en `CHANGELOG-TEVSYS.md`. **Motion home (abr 2026):** si se tocan duraciones o capas de la portada (tema oscuro), actualizar **`docs/MOTION_HOME_TEVSYS_HANDOFF_IA.md`** y la sección Motion del changelog.
...
- `precision`
  ...
  - Hook: `71 operativas documentadas. 0,06% de error medio en condiciones normales.` *(26 Mar 2026; §58)*
- `hyperclose`
...
| Resumen estadístico (0,06%) | KPIs + enlace auditoría | 71 operativas documentadas | ✅ |
