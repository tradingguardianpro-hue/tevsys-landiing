...
**Copy:** Hook **95 operativas** + 0,06% (fuente MD operativas proyecto TGP §3).
...
```
Estado web tevsys (jun 2026): contador **95** operativas (`settings.js`). Precisión: hero evidencia-100k-perdida.mp4, volatilidad + cuenta pequeña + logs compactos. HyperClose: vídeo 2:23, galería 6 + HTML historial; modales 3 PNG; Día OFF con vídeo + capturas. Evidencia: hero 100k, 4.56, auditoría 95. SML: falta sml-demo. Videos: public/videos/features/. Docs: PROMPT_MAESTRO §7, CONTENIDO_WEB, ARREGLOS_WEB.
