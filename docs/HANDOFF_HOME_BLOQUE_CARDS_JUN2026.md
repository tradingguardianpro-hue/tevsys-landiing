...
8. **Grid 4 cards** — títulos **Inter bold** blanco `#f4f6f8`; **subrayado fino parcial** `.tevsys-card__title--accent-line` (2px, ámbar→gris, offset/ancho por card — prueba jun 2026).
