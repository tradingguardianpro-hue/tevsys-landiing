...
- Hook: `87 operativas documentadas. 0,06% de error medio en condiciones normales.` (fuente: `PRECISION_MILIMETRICA_EVIDENCIADA_CON_OPERATIVAS_REALES.md` §3, proyecto TGP)
...
7. Guía logs
8. **Auditoría: 87 operativas documentadas**, incluyendo caso extremo 100 lotes
9. CTA final
...
- **description:** `Plataforma de disciplina automatizada para MetaTrader 5. Límites de pérdida y ganancia que se cumplen. Cierre preciso documentado. 87 operativas con evidencia verificable. Para traders, prop firms y auditorías.`
