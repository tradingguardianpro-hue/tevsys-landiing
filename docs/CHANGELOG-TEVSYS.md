...
- **Presentación:** iframes YouTube con **borde recto** (`border-radius: 0`); los bloques con barrido/motion (**De cero…**, **Siguiente nivel**) mantienen **contenedor redondeado** (oval / pill del stage).
